...
DATASET_ROOT="/home/serailhydra/CK-TOOLS/dataset-iwslt15-english-vietnamese-all"
...
$PREFIX "${CK_ENV_COMPILER_PYTHON_FILE}" -m nmt.nmt --src=en --tgt=vi \
                           ...
                           --train_prefix=$DATASET_ROOT/iwslt15_en-vi/train \
                             --dev_prefix=$DATASET_ROOT/iwslt15_en-vi/tst2012 \
                            --test_prefix=$DATASET_ROOT/iwslt15_en-vi/tst2013
