...
# CK 
TRAIN_DIRECTORY="${CK_ENV_DATASET_IMAGENET_TRAIN}/"
VALIDATION_DIRECTORY="${CK_ENV_DATASET_IMAGENET_VAL}/"
...
"${CK_ENV_COMPILER_PYTHON_FILE}" "${PREPROCESS_VAL_SCRIPT}" "${VALIDATION_DIRECTORY}" "${VAL_LABELS_FILE}"
...
"${CK_ENV_COMPILER_PYTHON_FILE}" "${BOUNDING_BOX_SCRIPT}" "${BOUNDING_BOX_DIR}" "${LABELS_FILE}" \
...
"${CK_ENV_COMPILER_PYTHON_FILE}" "${BUILD_SCRIPT}" \
