...
#
# Convert raw output of an avgpool test program to the CK format.
#
# Developer(s):
...
#    d['env']['CK_POOL_KERNEL']=env.get('CK_POOL_KERNEL','')
#    d['env']['CK_POOL_PAD']=env.get('CK_POOL_PAD','')
#    d['env']['CK_POOL_STRIDE']=env.get('CK_POOL_STRIDE','')
